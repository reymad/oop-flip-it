...
var fichas = [
    ...
    { id:Math.random().toString(36).substr(2), data_id: 'd', isFoto: true, fbg:'aqua', bbg: 'https://pbs.twimg.com/profile_images/206925366/newprox_bigger.jpg', nombre: Math.random().toString(36).substr(2) },
